...
public class FloatMenu extends PopupWindow {
    ...
    public FloatMenu(Context context, View view) {
        ...
        this.view = view;
        VERTICAL_OFFSET = CommonUtil.dip2px(context, 10);
        DEFAULT_MENU_WIDTH = CommonUtil.dip2px(context, 180);
    ...
    private void generateLayout(int itemWidth) {
        ...
        menuLayout.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.float_menu_bg_shadow));
        menuLayout.setOrientation(LinearLayout.VERTICAL);
        int padding = CommonUtil.dip2px(context, 12);
        for(int i = 0; i < menuItemList.size(); i ++){
            TextView textView = new TextView(context);
            textView.setClickable(true);
            textView.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.float_menu_item_selector));
            ...
            if(menuModel.getItemResId() != View.NO_ID){
                ...
                textView.setCompoundDrawablePadding(CommonUtil.dip2px(context, 12));
