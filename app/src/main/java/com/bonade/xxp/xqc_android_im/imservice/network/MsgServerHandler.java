...
public class MsgServerHandler extends SimpleChannelHandler {
    ...
    public void channelDisconnected(ChannelHandlerContext ctx, ChannelStateEvent e) throws Exception {
        ...
        IMHeartBeatManager.getInstance().onMsgServerDisconn();
    }
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) throws Exception {
        ...
        if (null != channelBuffer) {
            IMSocketManager.getInstance().packetDispatch(channelBuffer);
        }
    }
     ...
     * a.另外exceptionCaught 之后channelDisconnected 依旧会被调用。 [切换网络方式]
